# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-08-16 11:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('typical_application', models.CharField(max_length=100, verbose_name='Typical Application')),
                ('comments', models.TextField(blank=True, null=True, verbose_name='Comments')),
            ],
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='library.SampleProtocol', verbose_name='Sample Protocol'),
        ),
        migrations.AddField(
            model_name='sample',
