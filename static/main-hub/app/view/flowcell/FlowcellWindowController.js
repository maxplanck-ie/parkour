Ext.define('MainHub.view.flowcell.FlowcellWindowController', {
    ...
    initializeLaneDropZone: function(v) {
        ...
        var sequencer = Ext.getStore('sequencersStore').findRecord('id', sequencerId);
        ...
        v.dropZone = Ext.create('Ext.dd.DropZone', v.el, {
            ...
            onNodeOver: function(target, dd, e, data) {
                var pool = poolsStore.findRecord('name', data.poolData.name);
                var poolSize = Ext.getStore('poolSizesStore').findRecord('id', pool.get('pool_size_id'));
    ...
    unloadLane: function(lanesStore, record) {
        var poolsStore = Ext.getStore('poolsStore');
        var pool = poolsStore.findRecord('pk', record.get('pool_id'));
    ...
    save: function(btn) {
        ...
        form.submit({
            ...
            success: function(f, action) {
                new Noty({
                    text: 'Flowcell has been successfully loaded!'
                }).show();
